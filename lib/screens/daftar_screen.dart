      ...
      if (response.statusCode == 200) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Error fetching gerai: ${response.statusCode}')),
          );
        }
      }
    } catch (e) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        if (responseData['status'] == 'success') {
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text(responseData['message'] ?? 'Pendaftaran berhasil')),
            );
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: const Icon(Icons.person, color: Color(0xFFD4B89C)),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: const Icon(Icons.person_outline, color: Color(0xFFD4B89C)),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: const Icon(Icons.phone_android, color: Color(0xFFD4B89C)),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: const Icon(Icons.email, color: Color(0xFFD4B89C)),
                            labelText: 'Email',
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: const Icon(Icons.store, color: Color(0xFFD4B89C)),
